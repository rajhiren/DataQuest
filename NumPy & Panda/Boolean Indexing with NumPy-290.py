...
# we could have use following function if DQ let us 
# def get_total_rides(pickup_month,month):
#     month_bool = pickup_month == month
#     month = pickup_month[month_bool]
#     return month.shape[0]
# february_rides = get_total_rides(pickup_month,2)
...
# get total trips to jfk
jfk = taxi[taxi[:,6] == 2]
jfk_count = jfk.shape[0]

# get total trips to laguardia
laguardia = taxi[taxi[:,6] == 3]
laguardia_count = laguardia.shape[0]

# get total trips to newark
