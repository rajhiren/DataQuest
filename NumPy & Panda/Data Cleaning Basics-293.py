...
for label in laptops.columns:
    new_columns.append(label.strip())
...
def clean_col(col):
    """Accepts string and clean that string.
       
    Args:
        col (str): String to clean. 
         
    Returns:
        str: it will return cleaned `str` value.       
    """
    col = col.strip()
...
# add clean column name to new_columns
new_columns = []
